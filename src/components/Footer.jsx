...
const Footer = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-start gap-5 lg:gap-0 lg:items-center bg-black text-white text-[18px] lg:text-[22px] w-full py-10 lg:py-20 px-6 lg:px-0">
